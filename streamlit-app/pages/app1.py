...
def app():
    ...
    st.write("This Project uses Fine Tuned InceptionV3 Model which is a Pre-Trained CNN Model from Keras.")
    st.write("It Gave the Highest Accuracy of 96% while classifying image from test set.")
