...
def app():
    ...
    st.markdown("Visit the Hack4Good Home page <a href='https://hack4good.ieee-cis-sbc.org/' target='_blank' rel='noopener noreferrer'>`here`</a></b>", True)
    ...
    st.markdown("Visit Kaggle for Data <a href='https://www.kaggle.com/asdasdasasdas/garbage-classification' target='_blank' rel='noopener noreferrer'>`here`</a>", True)
    ...
    st.subheader("Code :")
    st.markdown("Full code and files for this project are availabe on my github repository <a href='https://github.com/DataRohit/Garbage-Image-Classification' target='_blank' rel='noopener noreferrer'>`here`</a>.", True)
